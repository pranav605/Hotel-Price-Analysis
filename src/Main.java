...
//        }
//
//        baseURL = "https://www.airbnb.ca/s/"+cityName+", "+provinceState+", "+country+"/homes?checkin="+startDate+"&checkout="+endDate+"&adults="+totalAdults+"&search_type=filter_change&l2_property_type_ids[]=4";
//        hc.crawl(baseURL, cityInJSON, filePath, "airbnb");
//        hc.wrapJsonWithArray(filePath);
//
...
//        hc.wrapJsonWithArray(filePath);
        ...
        String[] files = {"D:\\ACC Project\\ACCProject\\HotelsCA.json","D:\\ACC Project\\ACCProject\\AirbnbNew.json","D:\\ACC Project\\ACCProject\\BookingCA.json"};
        try{
